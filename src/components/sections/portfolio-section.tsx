...
export default function PortfolioSection() {
  ...
  return (
    <div className="bg-[#d4ebe8] box-border content-stretch flex flex-col gap-12 lg:gap-20 items-center justify-start px-5 lg:px-16 py-16 lg:py-28 relative w-full" ref={ref}>
      <motion.div 
        className="content-stretch flex flex-col gap-12 lg:gap-20 items-start justify-start max-w-[1280px] relative shrink-0 w-full"
      ...
      >
        ...
        {/* Portfolio Content */}
        <div className="content-stretch flex flex-col gap-10 lg:gap-16 items-center justify-start relative shrink-0 w-full">
          <div className="content-stretch flex flex-col items-start justify-start relative shrink-0 w-full">
            
            {portfolioProjects.map((project, index) => (
              <motion.div 
                key={index}
                className="box-border content-stretch flex flex-col gap-8 lg:gap-12 items-start justify-start px-0 py-8 lg:py-12 relative shrink-0 w-full group"
                variants={projectVariants}
              >
                {/* Divider line */}
                <div className="absolute border-t-2 inset-x-0 top-0 pointer-events-none" style={{ borderColor: '#103e39' }} />
                
                <div className="content-stretch flex flex-col lg:flex-row gap-6 lg:gap-20 items-start justify-start relative shrink-0 w-full">
                  {/* Project Image */}
                  <motion.div 
                    className="content-stretch flex flex-col h-[251px] lg:h-auto items-start lg:items-end justify-center relative shrink-0 w-full lg:basis-0 lg:grow"
                  ...
                  >
                    <div 
                      className="aspect-[335/251] lg:aspect-[600/450] h-[251px] lg:h-auto bg-center bg-cover bg-no-repeat rounded-2xl shrink-0 w-full shadow-lg group-hover:shadow-xl transition-shadow duration-300"
                  ...
                  {/* Project Content */}
                  <div className="content-stretch flex flex-col gap-6 lg:gap-8 grow items-start justify-center relative w-full lg:basis-0">
                    <div className="content-stretch flex flex-col gap-4 items-start justify-start relative shrink-0 w-full">
                      <div className="content-stretch flex flex-col gap-2 items-start justify-start leading-[0] relative shrink-0 text-[#0c0805] w-full">
                        <motion.div 
                          className="font-medium relative shrink-0 text-[24px] lg:text-[40px] tracking-[-0.24px] lg:tracking-[-0.4px] w-full group-hover:text-[#103E39] transition-colors duration-300" 
                          style={{ fontFamily: "'Anybody', sans-serif", fontVariationSettings: "'wdth' 100" }}
                        ...
                        <div 
                          className="not-italic relative shrink-0 text-[14px] lg:text-[18px] w-full max-w-[560px]" 
                          style={{ fontFamily: "'PT Sans', sans-serif" }}
                        >
                      ...
                      <div className="content-start flex flex-wrap gap-2 items-start justify-start relative shrink-0 w-full">
                        {project.tags.map((tag, tagIndex) => (
                          <motion.div 
                            key={tagIndex}
                            className="bg-[rgba(12,8,5,0.05)] box-border content-stretch flex items-start justify-start px-3 py-1 relative rounded-[100px] shrink-0 hover:bg-[rgba(12,8,5,0.1)] transition-colors duration-200"
                            whileHover={{ scale: 1.02 }}
                            style={{ border: '2px solid #103e39' }}
                          >
                            <div 
                              className="font-bold leading-[0] not-italic relative shrink-0 text-[#0c0805] text-[12px] lg:text-[16px] text-nowrap" 
                              style={{ fontFamily: "'PT Sans', sans-serif" }}
                            >
                    ...
                    <div className="content-stretch flex flex-col gap-4 items-start justify-start relative shrink-0 w-full">
                      ...
                      >
                        <div 
                          className="font-bold leading-[0] not-italic relative shrink-0 text-[#0c0805] text-[14px] lg:text-[18px] text-nowrap group-hover/btn:text-[#103E39] transition-colors duration-200" 
                          style={{ fontFamily: "'PT Sans', sans-serif" }}
                        >
